...
// console.log("w1");
// mongoose.connect(
//   "mongodb+srv://rogueprogrammer:chat@cluster0.2yxwd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
// );
// const chatDBSchema = new mongoose.Schema({
//   name: String,
// });
// const chatDB = mongoose.model("Chat", chatDBSchema);

// const silence = new Chat({ name: "Silence" });
